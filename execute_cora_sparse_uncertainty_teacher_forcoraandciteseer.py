...
checkpt_file = 'pre_trained/cora/mod_cora500_teacher{}.ckpt'.format(seed)

dataset = 'cora'
gat_pred_data = np.load("/network/rit/lab/ceashpc/sharedata_shu/gat_baseline/gat_{}_{}.npy".format(dataset, seed))
# gat_pred_data = np.load("pre_trained/pubmed/gat_{}_{}.npy".format(dataset, seed))
...
with tf.Graph().as_default():
    ...
    # with tf.Session() as sess:
        ...
        np.save("/network/rit/lab/ceashpc/sharedata_shu/hidden/hidden_gat_feature_{}.npy".format(dataset), np.mean(Baye_hidden, axis=0))
        np.save("/network/rit/lab/ceashpc/sharedata_shu/hidden/Baye_gat_result_{}.npy".format(dataset), Baye_result)
