...
checkpt_file = 'pre_trained/cora/mod_pubmed_teacher_cotrain{}.ckpt'.format(seed)
...
with tf.Graph().as_default():
    ...
    train_op, vars = model.training(loss, lr, l2_coef)
    ...
    # with tf.Session() as sess:
        ...
        for epoch in range(nb_epochs):
            ...
            # print("log_resh2hs= ", log_resh2hs)
            # print("loss111=%.5f,loss222=%.5f" % (loss111, loss222))
            print('Training: loss = %.5f, acc = %.5f | Val: loss = %.5f, acc = %.5f | epoch = %d' %
                    (train_loss_avg/tr_step, train_acc_avg/tr_step,
                    val_loss_avg/vl_step, val_acc_avg/vl_step, epoch))

            print("vacc_mx= %.5f, vlss_mn= %.5f, train_loss_avg=%.5f, tr_step=%.5f, val_loss_avg=%.5f, vl_step = %.5f" % (vacc_mx, vlss_mn, train_loss_avg, tr_step, val_loss_avg, vl_step))
